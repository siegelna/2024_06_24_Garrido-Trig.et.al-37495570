...
### Page title 
titlePanel("UC and Crohn's IBD from colonic mucosa scRNAseq"),  
navbarPage( 
  NULL,  
 navbarMenu("All",### Tab1.a1: cellInfo vs geneExpr on dimRed 
  tabPanel( 
...
navbarMenu("UC",### Tab1.a1: cellInfo vs geneExpr on dimRed 
  tabPanel( 
    HTML("CellInfo vs GeneExpr"), 
    h4("Cell information vs gene expression on reduced dimensions"), 
    "In this tab, users can visualise both cell information and gene ",  
...
navbarMenu("CD",### Tab1.a1: cellInfo vs geneExpr on dimRed 
  tabPanel( 
    HTML("CellInfo vs GeneExpr"), 
    h4("Cell information vs gene expression on reduced dimensions"), 
    "In this tab, users can visualise both cell information and gene ",  
...
navbarMenu("Healthy",### Tab1.a1: cellInfo vs geneExpr on dimRed 
  tabPanel( 
    HTML("CellInfo vs GeneExpr"), 
    h4("Cell information vs gene expression on reduced dimensions"), 
    "In this tab, users can visualise both cell information and gene ",  
